import 'package:shop4you_admin/models/address_model.dart';
import 'package:shop4you_admin/models/place_order_model.dart';
...
class OrderModel {
  ...
  OrderModel.fromJson(Map<String, dynamic> map) {
    ...
    deliveryAddress = map['deliveryAddress'] != null
        ? AddressModel.fromJson(map['deliveryAddress'] as Map<String, dynamic>)
        : null;
